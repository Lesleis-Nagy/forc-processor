...
/**
 ** \file simple_expression.tab.hh
 ** Define the mimg::parser class.
 */
...
#line 66 "simple_expression.tab.hh"
...
switch (yykind)
    {
      ...
      {
        return SimpleExpressionParser::symbol_name (this->kind ());
      }
#endif // #if YYDEBUG || 0
    ...
    SimpleExpressionParser (SimpleExpressionScanner  &scanner_yyarg, SimpleExpressionDriver  &driver_yyarg);
    virtual ~SimpleExpressionParser ();

#if 201103L <= YY_CPLUSPLUS
    /// Non copyable.
    SimpleExpressionParser (const SimpleExpressionParser&) = delete;
    /// Non copyable.
    SimpleExpressionParser& operator= (const SimpleExpressionParser&) = delete;
#endif
...
#if YY_CPLUSPLUS < 201103L
    /// Non copyable.
    SimpleExpressionParser (const SimpleExpressionParser&);
    /// Non copyable.
    SimpleExpressionParser& operator= (const SimpleExpressionParser&);
#endif
  ...
  private:
    ...
    // User arguments.
    SimpleExpressionScanner  &scanner;
...
#endif // !YY_YY_SIMPLE_EXPRESSION_TAB_HH_INCLUDED
