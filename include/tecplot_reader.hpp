...
namespace mimg {
    ...
    public:
        ...
        TecplotData read_file(const std::string &file_name) {
            ...
            while (std::getline(fin, line)) {
                ...
                if (std::regex_match(line, match_zone, _regex_zone)) {
                    ...
                    if (zone_counter == 1) {
                        ...
                        if ((!curves._n_verts.has_value()) && (!curves._n_elems.has_value())) {
...
//                    std::cout << "FLOAT LINE: " << line << "\n";
            ...
            curves._processing_time = std::chrono::duration_cast<std::chrono::minutes>(stop - start);
